...
import { getVendorsColumns } from "@/lib/constants/tableColumns";
...
export default function Vendor() {
  ...
  const columns = getVendorsColumns(handleEdit);
