...
import { getRoleDesigAdministration } from "@/lib/constants/tableColumns";
...
export default function Administration() {
  ...
  const {
    ...
    data: allAdminisData,
    refetch,
  } = useGet<[]>("/role-designation?stakeholderID=STK-1", [
  ...
  const columns = getRoleDesigAdministration(handleEdit);
