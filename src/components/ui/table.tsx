...
function TableBody({ className, ...props }: React.ComponentProps<"tbody">) {
  return (
    <tbody
      ...
      className={cn("border-y border-gray-200", className)}
  ...
  return (
    <th
      ...
      className={cn(
        ...
        // "capitalize  h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props}
    />
